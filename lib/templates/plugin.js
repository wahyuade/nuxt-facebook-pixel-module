...
class Fb {
   ...
   * @method track
   */
  trackSingle (event = null, parameters = null, eventId = null) {
    if (!event) {
      event = this.options.track
    }

    this.query('trackSingle', event, parameters, eventId)
  }
  ...
  query (cmd, option, parameters = null, eventId = null) {
    ...
    if (cmd === 'trackSingle') {
      ...
      this.fbq(cmd, this.options.pixelId, option, parameters, pixelOptions)
      return
    }
    if (!parameters) {
      this.fbq(cmd, option)
  ...
  if (typeof window !== 'undefined') {
    ((f, b, e, v, n, t, s) => {
      ...
      if (!isDev && !pixelOptions.disabled) {
        ...
        if (pixelOptions.disablePushState) {
